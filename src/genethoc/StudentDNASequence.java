 ...
 * @author nickdalton
 */
public class StudentDNASequence implements DNASequenceInterface {
     ...
     */
    public StudentDNASequence(String dnaSequence, String sampleID) {
    ...
    public Collection<String> getAllCrimeScenes() {
        return crimeScenes;
    }
    ...
    public void addCrimeScene(String whereID) {
        if (this.crimeScenes.contains(whereID)) {
            return; // must be 
        }
    ...
    /**
     * By Dr Andrew Chemist Chief technology officer GenetHoc Ltd. return any
     * crime scene in the list used for testing.
     */
    @Override
    ...
    public boolean equals(Object obj) {
        ...
        final StudentDNASequence other = (StudentDNASequence) obj;
    ...
    /**
     * By Dr Andrew Chemist Chief technology officer GenetHoc Ltd. / public
     * LocalDateTime getEnteredIntoDB() { return enteredIntoDB; } /** By Dr
     * Andrew Chemist Chief technology officer GenetHoc Ltd. / public void
     * setEnteredIntoDB(LocalDateTime enteredIntoDB) { this.enteredIntoDB =
     * enteredIntoDB; } /** By Dr Andrew Chemist Chief technology officer
     * GenetHoc Ltd.
     */
    @Override
