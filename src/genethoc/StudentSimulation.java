 ...
 * @author nickdalton
 */
public class StudentSimulation implements GenHocDNAInterface {
    ...
    public DNASequenceInterface makeRandomDNASequence(int maxCrimeScens) {
        DNASequenceInterface it = new StudentDNASequence(DNASequenceInterface.generateRandomDNA(dice),
                "" + (++idCode));
    ...
    /**
     * By Dr Andrew Chemist Chief technology officer GenetHoc Ltd. this creates
     * a fake database - note will always take 2 seconds.
     *
     */
    @Override
    ...
    /**
     * By Dr Andrew Chemist Chief technology officer GenetHoc Ltd. checks
     * database has not been corrupted. Kept disappearing.
     */
    @Override
    ...
    /**
     * By Dr Andrew Chemist Chief technology officer GenetHoc Ltd. take data
     * from the database and look for a match of a fragment inside the DNA list
     * you have
     *
    ...
    /**
     * By Dr Andrew Chemist Chief technology officer GenetHoc Ltd. Looks in the
     * crime scene for the
     *
    ...
    public int howManySequencesForCrimeScene(String crimeSceneCode) {
        ...
        for (DNASequenceInterface seq : database) {
            if (seq.linkedToCrimeScene(crimeSceneCode) == true) {
                howMany += 1;
            }
        }
    ...
    /**
     * contactDatabase in this case call the load DNAFromDatabase By Dr Andrew
     * Chemist Chief technology officer GenetHoc Ltd.
     */
    @Override
    ...
    /**
     * By Dr Andrew Chemist Chief technology officer GenetHoc Ltd. take data
     * from the database and sees if the whole sequence matches a whole
     * sequence.
     *
